                    ...
                    <tr>
                        <td style="padding:20px 24px;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:14px;line-height:1.7;">
                                ...
                                @endif
                                @if(!empty($contact->itinerary))
                                <tr>
                                    <td style="color:#6b7280;">Hải trình:</td>
                                    <td>{{ $contact->itinerary }}</td>
                                </tr>
                                @endif
                                @if(!empty($contact->departure_date))
                                <tr>
                                    <td style="color:#6b7280;">Ngày khởi hành:</td>
                                    <td>{{ $contact->departure_date }}</td>
                                </tr>
                                @endif
                                @if(!empty($contact->guest_count))
                                <tr>
                                    <td style="color:#6b7280;">Số lượng khách:</td>
                                    <td>{{ $contact->guest_count }}</td>
                                </tr>
                                @endif
                                @if(!empty($contact->service_cate_slug))
                                <tr>
                                    <td style="color:#6b7280;">Slug danh mục DV:</td>
                                    <td>{{ $contact->service_cate_slug }}</td>
                                </tr>
                                @endif
