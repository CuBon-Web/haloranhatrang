...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	// Marina Cards Slider
	if ($('.marina-cards-slider').length) {
		$('.marina-cards-slider').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 22,
			nav: true,
	...
	if ($('#swiperThemarina').length && typeof Swiper !== 'undefined') {
        var swiper_1 = new Swiper('#swiperThemarina .swiper', {
            slidesPerView: 1.2,
            spaceBetween: 20,
            speed: 1500,
			loop: false,
            navigation: {
              nextEl: "#swiperThemarina .swiper-button-next",
              prevEl: "#swiperThemarina .swiper-button-prev",
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
  ...
  $(".quantity-box .sub").on("click", function () {
	...
	if ($.fn.bxSlider && $('.product-details .bxslider').length) {
