...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('uu-dai.html','PageController@duanTieuBieu')->name('duanTieuBieu');

    Route::get('uu-dai/{slug}.html','PageController@duanTieuBieuDetail')->name('duanTieuBieuDetail');
    ...
    Route::get('haitrinh.html','PageController@haitrinh')->name('haitrinh');
    Route::get('hai-trinh/{slug}.html','PageController@haitrinhDetail')->name('haitrinhDetail');
