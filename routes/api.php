...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'website','namespace'=>'Website'], function(){
		...
		Route::post('itinerary/list','ItineraryController@list')->middleware('rbac.permission:website.view');
		Route::post('itinerary/create','ItineraryController@create')->middleware('rbac.permission:website.update');
		Route::get('itinerary/edit/{id}','ItineraryController@edit')->middleware('rbac.permission:website.view');
		Route::get('itinerary/delete/{id}','ItineraryController@delete')->middleware('rbac.permission:website.update');
	});
